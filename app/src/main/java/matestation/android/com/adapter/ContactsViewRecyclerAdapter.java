...
public class ContactsViewRecyclerAdapter extends RecyclerView.Adapter<ContactsViewRecyclerAdapter.ViewHolder> {
    ...
    public ContactsViewRecyclerAdapter(ArrayList<String> myDataset) {
        mDataset = myDataset;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public ContactsViewRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                   int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardview_fragment_contacts_view, parent, false);
    ...
    @Override
    public void onBindViewHolder(ContactsViewRecyclerAdapter.ViewHolder holder, int position) {
